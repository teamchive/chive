...
public class q extends MultiAutoCompleteTextView implements o {
    ...
    static {
        q.a = new int[]{0x1010176};
    }

    public q(Context arg2, AttributeSet arg3) {
        this(arg2, arg3, a.autoCompleteTextViewStyle);
    }

    public q(Context arg4, AttributeSet arg5, int arg6) {
        super(at.a(arg4), arg5, arg6);
        aw v0 = aw.a(this.getContext(), arg5, q.a, arg6, 0);
        if(v0.g(0)) {
